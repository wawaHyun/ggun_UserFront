...
export default function MiniProfile() {
    ...
    return (
        <div className="w-full h-full justify-center flex items-center relative top-0 flex-col">
            <div className="group/items w-full h-full">
                <div>
                    <Image src={"/imgs/user.gif"} alt={"user"} layout="fill" objectFit="" className="rounded-full" />
                </div>

                <button className="relative top-0 -right-[40%] w-[20px] h-[20px]" onClick={() => setIsOpen(!isOpen)}>
            ...
            <div className="relative top-1 hidden group-hover/item:block h-[1px] min-w-[100px]">
